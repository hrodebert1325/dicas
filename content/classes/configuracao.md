...
13 - **Exigir documento de identificação:** a marcação desse campo impede a possibilidade, em regra disponível para usuários internos, de autuar processos mesmo quando não existem de documentos de identificação das partes. 
