...
{{% notice note %}}
Caso prefira, acompanhe a execução do procedimento de elaboração de documento em lote assistindo a este vídeo: INSERIR VÍDEO ELABORAR_DOCUMENTOS_LOTE (//TODO) 
{{% /notice %}}